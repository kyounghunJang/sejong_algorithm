...
<p class="xt-translated"><img src="https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/0527a713-4fc4-47db-98d3-49ce6d911dfd/%E1%84%80%E1%85%B3%E1%84%85%E1%85%B5%E1%86%B76.png" title="" alt="그림6.png"><xt-dual class="xt-loading xt-dual inline" xt-origin="" style="opacity: 0.5; font-size: 16px;"></xt-dual></p>
...
<p class="xt-translated">각 판매원의 이름을 담은 배열 enroll, 각 판매원을 다단계 조직에 참여시킨 다른 판매원의 이름을 담은 배열 referral, 판매량 집계 데이터의 판매원 이름을 나열한 배열 seller, 판매량 집계 데이터의 판매 수량을 나열한 배열 amount가 매개변수로 주어질 때, 각 판매원이 득한 이익금을 나열한 배열을 return 하도록 solution 함수를 완성해주세요. 판매원에게 배분된 이익금의 총합을 계산하여(정수형으로), 입력으로 주어진 enroll에 이름이 포함된 순서에 따라 나열하면 됩니다.<xt-dual class="xt-dual block" xt-origin="각 판매원의 이름을 담은 배열 enroll, 각 판매원을 다단계 조직에 참여시킨 다른 판매원의 이름을 담은 배열 referral, 판매량 집계 데이터의 판매원 이름을 나열한 배열 seller, 판매량 집계 데이터의 판매 수량을 나열한 배열 amount가 매개변수로 주어질 때, 각 판매원이 득한 이익금을 나열한 배열을 return 하도록 solution 함수를 완성해주세요. 판매원에게 배분된 이익금의 총합을 계산하여(정수형으로), 입력으로 주어진 enroll에 이름이 포함된 순서에 따라 나열하면 됩니다." style="opacity: 0.5; font-size: 16px;" xt-translation="각 판매원의 이름을 포함하는 배열 등록, 각 판매원을 다단계 조직에 참여하는 다른 판매원의 이름을 갖는 배열 추천, 제한적인 변수의 판매원 이름을 포함하는 배열 판매자, 제외 데이터의 할인 수량을 포함하는 배열 금액이 다양한 다양성 관심이 있을 때, 각 판매원이 이익을 얻은 이익을 포함하는 배열을 반환하도록 솔루션을 완성해 주시기 바랍니다. 판매원에게 배분된 이익의 총합을 빼서(정수형으로), 입력으로 등록에 이름이 포함된 순서에 따라 알려주시면 됩니다."><xt-br></xt-br><xt-content style="opacity: 0.5;">각 판매원의 이름을 포함하는 배열 등록, 각 판매원을 다단계 조직에 참여하는 다른 판매원의 이름을 갖는 배열 추천, 제한적인 변수의 판매원 이름을 포함하는 배열 판매자, 제외 데이터의 할인 수량을 포함하는 배열 금액이 다양한 다양성 관심이 있을 때, 각 판매원이 이익을 얻은 이익을 포함하는 배열을 반환하도록 솔루션을 완성해 주시기 바랍니다. 판매원에게 배분된 이익의 총합을 빼서(정수형으로), 입력으로 등록에 이름이 포함된 순서에 따라 알려주시면 됩니다.</xt-content></xt-dual></p>
...
<td>[0, 110, 378, 180, 270, 450, 0, 0]</td>
      ...
      <xt-dual class="xt-dual block" xt-origin="enroll	referral	seller	amount	result
...
[&quot;john&quot;, &quot;mary&quot;, &quot;edward&quot;, &quot;sam&quot;, &quot;emily&quot;, &quot;jaimie&quot;, &quot;tod&quot;, &quot;young&quot;]	[&quot;-&quot;, &quot;-&quot;, &quot;mary&quot;, &quot;edward&quot;, &quot;mary&quot;, &quot;mary&quot;, &quot;jaimie&quot;, &quot;edward&quot;]	[&quot;sam&quot;, &quot;emily&quot;, &quot;jaimie&quot;, &quot;edward&quot;]	[2, 3, 5, 4]	[0, 110, 378, 180, 270, 450, 0, 0]" style="opacity: 0.5; font-size: 16px;" xt-translation="추천 판매자 금액 등록 결과
[&quot;john&quot;, &quot;mary&quot;, &quot;edward&quot;, &quot;sam&quot;, &quot;emily&quot;, &quot;jaimie&quot;, &quot;tod&quot;, &quot;young&quot;] [&quot;-&quot;, &quot;-&quot;, &quot;mary&quot;, &quot;edward&quot;, &quot;mary&quot;, &quot;mary&quot;, &quot;jaimie&quot;, &quot;edward&quot;] [&quot;young&quot;, &quot;john&quot;, &quot;tod&quot;, &quot;emily&quot;, &quot;mary&quot;] [12, 4, 2, 5, 10] [360, 958, 108, 0, 450, 18, 180, 1080]
[&quot;john&quot;, &quot;mary&quot;, &quot;edward&quot;, &quot;sam&quot;, &quot;emily&quot;, &quot;jaimie&quot; , &quot;tod&quot;, &quot;young&quot;] [&quot;-&quot;, &quot;-&quot;, &quot;mary&quot;, &quot;edward&quot;, &quot;mary&quot;, &quot;mary&quot;, &quot;jaimie&quot;, &quot;edward&quot;] [&quot;sam&quot;, &quot;emily&quot; , &quot;제이미&quot;, &quot;에드워드&quot;] [2, 3, 5, 4] [0, 110, 378, 180, 270, 450, 0, 0]"><xt-br></xt-br><xt-content style="opacity: 0.5;">추천 판매자 금액 등록 결과
["john", "mary", "edward", "sam", "emily", "jaimie", "tod", "young"] ["-", "-", "mary", "edward", "mary", "mary", "jaimie", "edward"] ["young", "john", "tod", "emily", "mary"] [12, 4, 2, 5, 10] [360, 958, 108, 0, 450, 18, 180, 1080]
["john", "mary", "edward", "sam", "emily", "jaimie" , "tod", "young"] ["-", "-", "mary", "edward", "mary", "mary", "jaimie", "edward"] ["sam", "emily" , "제이미", "에드워드"] [2, 3, 5, 4] [0, 110, 378, 180, 270, 450, 0, 0]</xt-content></xt-dual></table>
<h5>입출력 예 설명</h5>
